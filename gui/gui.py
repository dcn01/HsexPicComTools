...
class mainGUI(Ui_index_main):
    ...
    def __init__(self):
        ...
        self.off_line_page.origin_path_button.clicked.connect(self.get_origin_pic_file_path_by_offline)
        self.off_line_page.select_path_button.clicked.connect(self.get_select_pic_path_by_offline)
        self.off_line_page.result_path_button.clicked.connect(self.get_result_pic_path_by_offline)
        self.off_line_page.execute_button.clicked.connect(self.execute_offline)
        self.th_offline.sin_out.connect(self.print_logs_by_offline)
        self.th_offline.sin_work_status.connect(self.execute_status)
        self.off_line_page.clear_log_button.clicked.connect(self.clear_log)
    ...
    def get_origin_pic_file_path_by_offline(self):
        ...
        pic_name = QFileDialog.getOpenFileName(self, '选取源文件路径', os.getcwd(), '*.jpg;;*.png')
        self.origin_pic_file_path = pic_name[0]
        self.off_line_page.origin_pic_path_line.setText(self.origin_pic_file_path)
    ...
    def get_select_pic_path_by_offline(self):
        ...
        """
        self.log_path_flor = QFileDialog.getExistingDirectory(self, '设置日志路径存放地址', os.getcwd())
        self.off_line_page.select_pic_path_line.setText(self.log_path_flor)
    ...
    def get_result_pic_path_by_offline(self):
        ...
        """
        self.log_path_flor = QFileDialog.getExistingDirectory(self, '设置日志路径存放地址', os.getcwd())
        self.off_line_page.result_pic_path_line.setText(self.log_path_flor)
    ...
    def print_logs_by_offline(self, text):
        ...
        :return:
        """
        self.off_line_page.log_textBrowser.insertPlainText(text + '\n')

    def clear_log(self):
        self.off_line_page.log_textBrowser.clear()
